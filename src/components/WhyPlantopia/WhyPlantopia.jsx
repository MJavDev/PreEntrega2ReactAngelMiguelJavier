      ...
      <div className="why_section">
        ...
        <div className="why_row1">
          ...
          <p className="why_text">
            We’re committed to supplying London’s best houseplants, handpicked
            by our growers in The Netherlands. In fact, it’s so important to us
            that we visit our nurseries in person regularly to ensure that we’re
            happy with the quality and range we’re offering.
          </p>
        </div>
        ...
        <div className="why_row2">
          ...
          <p className="why_text">
            Some shops charge extortionate prices for plants – we want to change
            that. We believe that nature should be for everyone, meaning that
            we’re committed to making plants affordable.
          </p>
        </div>
